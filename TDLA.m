function [DR_test_set,DR_train_set] = TDLA_func(train_set,train_label,test_data,J1,J2,I1,I2,k1,k2)
...
[N1,D1] = size(test_data);
test_data = reshape( test_data',[I(1),I(2),N1]);
test_data = tensor(test_data,[I(1),I(2),N1]);
mid2 = ttm(test_data, {Res{1,1}',Res{1,2}'}, [1 2]);
DR_test_set = tenmat(mid2,3);
mid22 = ttm(train_set, {Res{1,1}',Res{1,2}'}, [1 2]);
DR_train_set = tenmat(mid22,3);
